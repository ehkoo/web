...
excerpt: "Bạn có nghe đến kỹ thuật currying trong lập trình hàm chưa? Hãy cùng Ehkoo tìm hiểu xem nó là gì, và ứng dụng để xây dựng một game Calculator đơn giản với React nhé."
author: kcjpop
---
